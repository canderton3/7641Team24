...
data_w_labels = np.concatenate((scaled_top_5, dbscan_labels.reshape(dbscan_labels.shape[0], 1)), axis=1)
data_w_labels = np.concatenate((top_5_labels.reshape(top_5_labels.shape[0], 1), data_w_labels), axis=1)
